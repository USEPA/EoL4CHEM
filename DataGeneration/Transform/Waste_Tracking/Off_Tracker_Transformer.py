    ...
    def retrieving_needed_information(self):
        ...
        if self.database == 'TRI':
            ...
            cols = ['REPORTING YEAR', 'SENDER FRS ID', 'SENDER LATITUDE', 'SENDER LONGITUDE', \
                    ...
                    'FOR WHAT IS TRANSFERRED', 'UNIT OF MEASURE', 'RECEIVER FRS ID', 'RECEIVER TRI ID', \
            ...
            _df['RECEIVER TRI ID'] = _df['PGM_SYS_ID']
            ...
            cols = ['REPORTING YEAR', 'SENDER FRS ID', 'SENDER LATITUDE', 'SENDER LONGITUDE', \
                    ...
                    'RECEIVER FRS ID', 'RECEIVER TRI ID', 'RECEIVER LATITUDE', 'RECEIVER LONGITUDE']
            columns_needed = ['EPA Handler ID', 'Reporting Cycle Year', \
                        'Total Quantity Shipped Off-site (in tons)', \
                        'EPA ID Number of Facility to Which Waste was Shipped', \
                        'Waste Code Group', 'Waste Source Code', 'Management Method Code', \
            ...
            df['RECEIVER TRI ID'] = df['PGM_SYS_ID']
